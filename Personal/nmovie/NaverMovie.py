...
# 본격적으로 선택한 영화의 페이지에 들어가서 별점과 리뷰들을 수집합니다.
def collect_comments(target):
    # 선택한 영화의 페이지로 이동합니다.
...
def execute():
    ...
    ratings, res_df = collect_comments(target)
    return ratings, res_df